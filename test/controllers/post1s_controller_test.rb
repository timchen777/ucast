...
class Post1sControllerTest < ActionController::TestCase
  ...
  test "should create post1" do
    assert_difference('Post1.count') do
      post :create, post1: { category_id: @post1.category_id, content: @post1.content, title: @post1.title, user_id: @post1.user_id }
    end
  ...
  test "should update post1" do
    patch :update, id: @post1, post1: { category_id: @post1.category_id, content: @post1.content, title: @post1.title, user_id: @post1.user_id }
    assert_redirected_to post1_path(assigns(:post1))
  end
